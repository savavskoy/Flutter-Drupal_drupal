  ...
  <div id="footer">
    ...
    <div class="footer_credit">
      ...
      <?php if (theme_get_setting('social_links', 'starfish_responsive_theme')): ?>
        <div class="social-icons">
         <ul>
          ...
          <li><a class="linkedin" href="https://www.linkedin.com/in/oleh-savenko-7051061ba/" target="_blank" rel="me"><i class="fa fa-linkedin"></i></a></li>
      ...
      <div id="copyright">
        ...
        <p class="credits"> <?php print t('Design by'); ?>  <a href="https://www.linkedin.com/in/oleh-savenko-7051061ba/" target="_blank" rel="me">Oleh Savenko</a></p>
        <div class="clear"></div>
      </div>
    </div>
  </div>
